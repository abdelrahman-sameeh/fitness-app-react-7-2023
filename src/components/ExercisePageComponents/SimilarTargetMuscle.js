...
import SimilarTargetHook from '../../custom-hook/Exercise/similar-target-hook';




const SimilarTargetMuscle = () => {

   const [responsive, targetMuscles] = SimilarTargetHook()

   return (
      <div className="mt-5" style={{ userSelect: 'none' }}>

         <div className="title fs-1 fw-bold mb-2">
            Similar <span style={{ color: 'var(--main-color)' }} >Target Muscle </span> exercises
         </div>

         {  
            targetMuscles && targetMuscles.data.length ?
               <Carousel
               ...
               >
                  ...
                  {
                     targetMuscles.data.map(exercise => {
